...
def generate_answer_and_context(question: str, index_path: str, corpus_path: str, embedding_model, top_k: int = 5) -> Tuple[str, str]:
    ...
    Select useful parts from the Contexts that are relevant to answering the Question.
    If none of the Contexts are useful, say "No relevant information found".
    ...
    Provide an answer based on the Relevant Information.
    ...
    return answer, relevant_info, combined_context
...
if __name__ == "__main__":
    ...
    answer, relevant_info, retrieved_contexts = generate_answer_and_context(question, index_path, corpus_path, embedding_model, top_k=1)
